...
constexpr size_t CXWnd_size = 0x268; // @sizeof(CXWnd) :: 2026-05-26 (live) @ 0x1405D81C6
...
/*0x031*/ uint8_t            Unknown0x31[0x3];
/*0x034*/ uint32_t           BackgroundDrawType;  // unverified: no recovery signal, offset is a guess
/*0x038*/ bool               bKeepOnScreen;
/*0x039*/ bool               bIsParentOrContextMenuWindow;
/*0x03a*/ bool               bIsTransitioning;  // unverified: no recovery signal, offset is a guess
...
/*0x0cc*/ bool               bClickThroughMenuItemStatus;
...
/*0x266*/ uint8_t            Unknown0x266[0x2];
/*0x268*/
// @end: CXWnd Members
...
constexpr size_t CSidlScreenWnd_size = 0x2D0; // @sizeof(CSidlScreenWnd) :: 2026-05-26 (live) @ 0x1405F7B41
...
constexpr size_t CEQXWndManager_size = 0x298; // @sizeof(CEQXWndManager) :: 2026-05-26 (live) @ 0x14019F8E5
