...
/*0x01cc*/ char                     GM;
/*0x01cd*/ bool                     bSwitchMoved;  // unverified: no recovery signal, offset is a guess
/*0x01ce*/ uint8_t                  CharClass;  // unverified: no recovery signal, offset is a guess
/*0x01cf*/ uint8_t                  IntimidateCount;  // unverified: no recovery signal, offset is a guess
/*0x01d0*/ int                      Unknown3;
/*0x01d4*/ unsigned int             LoginSerial;
/*0x01d8*/ float                    AnimationSpeedRelated;
/*0x01dc*/ unsigned int             CorpseDragCount;  // unverified: no recovery signal, offset is a guess
...
/*0x0211*/ uint8_t                  Unknown0x211[0x3];
/*0x0214*/ unsigned int             CombatSkillUsed[CONCURRENT_SKILLS];  // unverified: no recovery signal, offset is a guess
/*0x021c*/ float                    MerchantGreed;
/*0x0220*/ int                      ManaMax;  // unverified: no recovery signal, offset is a guess
/*0x0224*/ float                    ViewHeight;
/*0x0228*/ void*                    pTouchingSwitch;
/*0x0230*/ uint8_t                  IsPassenger;
/*0x0231*/ uint8_t                  Blind;
/*0x0232*/ uint8_t                  Unknown0x232[0x2];
/*0x0234*/ int                      ManaCurrent;  // unverified: no recovery signal, offset is a guess
/*0x0238*/ int64_t                  HPMax;
/*0x0240*/ bool                     bAnimationOnPop;
/*0x0241*/ uint8_t                  Original;  // unverified: no recovery signal, offset is a guess
/*0x0242*/ bool                     bShowHelm;  // unverified: no recovery signal, offset is a guess
/*0x0244*/ int                      Buyer;
...
/*0x029c*/ unsigned int             StunTimer;  // unverified: no recovery signal, offset is a guess
/*0x02a0*/ int64_t                  GuildID;
/*0x02a8*/ bool                     bSummoned;
/*0x02ac*/ int                      Unknown1;
/*0x02b0*/ float                    FallingStartZ;
/*0x02b4*/ int                      IsAttacking;  // unverified: no recovery signal, offset is a guess
/*0x02b8*/ int                      Anon;
/*0x02bc*/ int                      DoSpecialMelee;
/*0x02c0*/ int                      PrimaryTintIndex;
/*0x02c4*/ uint8_t                  TitleVisible;
/*0x02c5*/ char                     DragNames[2][0x40];  // unverified: no recovery signal, offset is a guess
/*0x0345*/ uint8_t                  Unknown0x345[0x3];
/*0x0348*/ float                    MissileRangeToTarget;  // unverified: no recovery signal, offset is a guess
/*0x034c*/ int                      Deity;
/*0x0350*/ unsigned int             LastPrimaryUseTime;
/*0x0354*/ float                    MyWalkSpeed;
/*0x0358*/ unsigned int             LastTrapDamageTime;  // unverified: no recovery signal, offset is a guess
/*0x035c*/ EqItemGuid               realEstateItemGuid;
/*0x036e*/ char                     Title[0x80];
/*0x03f0*/ int                      AltAttack;
/*0x03f4*/ bool                     bAttackRelated;
/*0x03f5*/ uint8_t                  Unknown0x3f5[0x3];
/*0x03f8*/ unsigned int             NextSwim;  // unverified: no recovery signal, offset is a guess
/*0x03fc*/ bool                     LFG;
/*0x03fd*/ uint8_t                  Level;
/*0x0400*/ int                      PetID;
/*0x0404*/ int                      EnduranceCurrent;  // unverified: no recovery signal, offset is a guess
/*0x0408*/ int                      RealEstateID;
/*0x040c*/ bool                     bBuffTimersOnHold;
/*0x040d*/ char                     DraggingPlayer[0x40];  // unverified: no recovery signal, offset is a guess
/*0x0450*/ int                      AFK;
/*0x0454*/ unsigned int             RespawnTimer;
/*0x0458*/ float                    CameraOffset;
/*0x045c*/ unsigned int             EnduranceMax;  // unverified: no recovery signal, offset is a guess
/*0x0460*/ unsigned int             LastSecondaryUseTime;  // unverified: no recovery signal, offset is a guess
/*0x0464*/ uint8_t                  Unknown0x464[0x1];
/*0x0465*/ uint8_t                  HoldingAnimation;
/*0x0468*/ unsigned int             LastRefresh;
/*0x046c*/ unsigned int             MinuteTimer;
/*0x0470*/ bool                     PvPFlag;
/*0x0471*/ char                     Suffix[0x80];
/*0x04f1*/ uint8_t                  Unknown0x4f1[0x3];
/*0x04f4*/ float                    BearingToTarget;  // unverified: no recovery signal, offset is a guess
/*0x04f8*/ CharacterZoneClient*     pCharacter;
/*0x0500*/ uint8_t                  GMRank;
/*0x0501*/ uint8_t                  FindBits;
/*0x0502*/ uint8_t                  Unknown0x502[0x2];
/*0x0504*/ unsigned int             SpellGemETA[15];  // unverified: no recovery signal, offset is a guess
/*0x0540*/ int                      Birthdate;
/*0x0544*/ unsigned int             LastResendAddPlayerPacket;
/*0x0548*/ unsigned int             LastRangedUsedTime;
/*0x054c*/ bool                     Linkdead;
/*0x0550*/ int                      Trader;
/*0x0554*/ bool                     bStationary;
...
/*0x0574*/ unsigned int             Meditating;
/*0x0578*/ bool                     Mercenary;
/*0x057c*/ int                      Unknown4;
/*0x0580*/ bool                     bAlwaysShowAura;
/*0x0584*/ CPhysicsInfo             LastCollision;
/*0x05b4*/ bool                     berserker;
/*0x05b8*/ int                      SecondaryTintIndex;
/*0x05bc*/ unsigned int       ParticleCastDuration;  // unverified: no recovery signal, offset is a guess
/*0x05c0*/ int                      WarCry;
/*0x05c4*/ int                      SomeData[2];
/*0x05cc*/ char                     LoginRelated[0x20];
/*0x05f0*/ void*                    pRaceGenderInfo;
/*0x05f8*/ unsigned int             NextIntimidateTime;
/*0x05fc*/ uint8_t                  Unknown0x5fc[0x4];
/*0x0600*/ int                      HideMode;
/*0x0604*/ uint8_t                  LastAttack;
/*0x0608*/ float                    RunSpeed;
/*0x060c*/ uint8_t                  InPvPArea;
/*0x0610*/ unsigned int             SpellCooldownETA;
/*0x0614*/ uint8_t                  Unknown0x614[0x8];
/*0x061c*/ uint8_t                  FD;
/*0x0620*/ PlayerClient*            pViewPlayer;
/*0x0628*/ bool                     Sneak;
/*0x0629*/ uint8_t                  Unknown0x629[0xb];
/*0x0634*/ unsigned int             HibernatingCount;
/*0x0638*/ int                      CurrIOState;
/*0x063c*/ unsigned int             FishingETA;
/*0x0640*/ unsigned int             TimeStamp;
/*0x0644*/ uint8_t                  Unknown0x644[0x8];
/*0x064c*/ int                      RealEstateItemId;
/*0x0650*/ uint8_t                  FishingEvent;
/*0x0654*/ unsigned int             Zone;
/*0x0658*/ unsigned int             LastMealTime;
...
/*0x0fd4*/ uint8_t                  Unknown0xfd4[0x4];
...
constexpr size_t PlayerClient_size = 0x20D8; // @sizeof(PlayerClient) :: 2026-05-26 (live) @ 0x14030768E
