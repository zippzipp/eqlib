...
constexpr size_t EQGroundItem_size = 0xA0; // @sizeof(EQGroundItem) :: 2026-05-22 (live) @ 0x14020082F
...
constexpr size_t EQSwitch_size = 0x108; // @sizeof(EQSwitch) :: 2026-05-22 (live) @ 0x1401F777D
