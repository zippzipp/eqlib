...
constexpr size_t EQGroundItem_size = 0xA0; // @sizeof(EQGroundItem) :: 2026-06-11 (live) @ 0x140202C1C
...
constexpr size_t EQSwitch_size = 0x108; // @sizeof(EQSwitch) :: 2026-06-11 (live) @ 0x1401F9E6E
